    ...
    items: [
      {
        ...
        iconUrl: '/mall-tab-home.svg',
        activeIconUrl: '/mall-tab-home.svg'
      },
      {
        text: '分类',
        url: '/pages/index/category?id=3',
        iconUrl: '/mall-tab-category.svg',
        activeIconUrl: '/mall-tab-category.svg'
      },
      {
        text: '购物车',
        url: '/pages/index/cart',
        iconUrl: '/mall-tab-cart.svg',
        activeIconUrl: '/mall-tab-cart.svg'
      },
      {
        text: '我的',
        url: '/pages/index/user',
        iconUrl: '/mall-tab-user.svg',
        activeIconUrl: '/mall-tab-user.svg'
      }
    ]
  }
